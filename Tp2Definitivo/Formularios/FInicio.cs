    ...
    public partial class FInicio : Form
    {
        ...
        private bool ProcesarLineaImportacion(string[] datos)
        {
            ...
            try
            {
                ...
                Reserva importada = new Reserva(encontrado, propiedad, reservacion, fechaIngreso, fechaEgreso, nroReserva);
        ...
        private void RefrescarGrilla()
        {
...

            {
                ...
                dgvPropiedades.Rows.Add(nro, nombre, direccion, localidad, pasajeros, precio);
        ...
        private bool AgregarCasa()
        {
            ...
            try
            {
                if (aCasa.ShowDialog() == DialogResult.OK)
                {
                    ...
                    Casa nuevo = new Casa(direccion, nroCamas, nroCasa, pBase, nombre, localidad);
        ...
        private bool EditarCasa(Casa c)
        {
            ...
            CasasA casaA = new CasasA(c.Nro); //Creo un nuevo formulario
        ...
        private bool AgregarHotel()
        {
            ...
            try
            {
                if (aHotel.ShowDialog() == DialogResult.OK)
                {
                    ...
                    Hotel nuevo = new Hotel(direccion, habitaciones, nroHabitacion, tresEstrellas, pBase, nombre, localidad);
