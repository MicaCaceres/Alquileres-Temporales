...
namespace Tp2Definitivo.Clases
{
    ...
    class Hotel : Propiedad
    {
        ...
        public Hotel(string direccion, int numeroPiezas, int nroHabitacion, bool tresEstrellas, double precioBase, string nombre, string localidad) : base(direccion, nroHabitacion,nombre,localidad)
        {
